...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// name으로 가져오기
		System.out.println("----------------name으로 가져오기---------------");
		TestBean2 xml2 = ctx1.getBean("xml2", TestBean2.class);
		System.out.println("xml2 : "+xml2);
		TestBean2 xml3 = ctx1.getBean("xml2", TestBean2.class);
		System.out.println("xml3 : "+xml3);
		// component
		System.out.println("------------component으로 가져오기---------------");
		...
		TestBean5 xml10=ctx1.getBean(TestBean5.class);
		System.out.println("xml10 : "+xml10);
		...
		TestBean5 java10=ctx2.getBean(TestBean5.class);
